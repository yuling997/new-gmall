...
public class OssController {
    ...
    public Resp<Object> policy(){
        String accessId = "LTAI4FvsukAXRLEyrms3zow5"; // 请填写您的AccessKeyId。
        String accessKey = "zGGFDphDAC3NshlktjIhYj4KsccSsX"; // 请填写您的AccessKeySecret。
        String endpoint = "oss-cn-beijing.aliyuncs.com"; // 请填写您的 endpoint。
        String bucket = "gmall08"; // 请填写您的 bucketname 。
